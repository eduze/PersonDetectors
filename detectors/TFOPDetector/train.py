...
if __name__ == '__main__':
    ...
    parser.add_argument('--trained_model', default='mobilenet', help='trained_model name')
    ...
    # define trained_model for multi-gpu
    ...
    with tf.Session(config=config) as sess:
        ...
        while True:
            ...
            if gs_num - last_gs_num2 >= 1000:
                ...
                # save weights
                saver.save(sess, os.path.join(args.modelpath, 'trained_model'), global_step=global_step)
