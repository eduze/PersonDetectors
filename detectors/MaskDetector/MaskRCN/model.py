...
def build_rpn_model(anchor_stride, anchors_per_location, depth):
    """Builds a Keras trained_model of the Region Proposal Network.
    ...
    Returns a Keras Model object. The trained_model outputs, when called, are:
    rpn_logits: [batch, H, W, 2] Anchor classifier logits (before softmax)
...
def rpn_bbox_loss_graph(config, target_bbox, rpn_match, rpn_bbox):
    ...
    config: the trained_model config object.
...
class MaskRCNN():
    """Encapsulates the Mask RCNN trained_model functionality.

    The actual Keras trained_model is in the keras_model property.
    """
    ...
    def build(self, mode, config):
        """Build Mask R-CNN architecture.
            ...
            mode: Either "training" or "inference". The inputs and
                outputs of the trained_model differ accordingly.
        """
        assert mode in ['training', 'inference']
    ...
    def find_last(self):
        """Finds the last checkpoint file of the last trained trained_model in the
        trained_model directory.
        Returns:
            log_dir: The directory where events and weights are saved
            checkpoint_path: the path to the last checkpoint file
        """
        # Get directory names. Each directory corresponds to a trained_model
    ...
    def load_weights(self, filepath, by_name=False, exclude=None):
        ...
        # In multi-GPU training, we wrap the trained_model. Get layers
        # of the inner trained_model because they have the weights.
    ...
    def compile(self, learning_rate, momentum):
        """Gets the trained_model ready for training. Adds losses, regularization, and
    ...
    def set_trainable(self, layer_regex, keras_model=None, indent=0, verbose=1):
        """Sets trained_model layers as trainable if their names match
        ...
        for layer in layers:
            # Is the layer a trained_model?
            if layer.__class__.__name__ == 'Model':
                print("In trained_model: ", layer.name)
                self.set_trainable(
    ...
    def set_log_dir(self, model_path=None):
        """Sets the trained_model log directory and epoch counter.
        ...
        model_path: If None, or a format different from what this code uses
            ...
            name.
        """
        # Set date and epoch counter as if starting a new trained_model
        self.epoch = 0
        now = datetime.datetime.now()

        # If we have a trained_model path with date and epochs use them
        if model_path:
            # Continue from we left of. Get epoch and date from the file name
            # A sample trained_model path might look like:
    ...
    def train(self, train_dataset, val_dataset, learning_rate, epochs, layers):
        ...
        """
        assert self.mode == "training", "Create trained_model in training mode."
    ...
    def mold_inputs(self, images):
        ...
        windows = []
        for image in images:
            # Resize image to fit the trained_model expected size
    ...
    def detect(self, images, verbose=0):
        ...
        """
        assert self.mode == "inference", "Create trained_model in inference mode."
        assert len(
    ...
    def run_graph(self, images, outputs):
        ...
        #     if trained_model.uses_learning_phase and not isinstance(K.learning_phase(), int):
        #         model_in.append(1.)
